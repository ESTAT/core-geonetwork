   ...
   */
    ...
    final class InitThesauriTableTask implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                Log.error(Geonet.THESAURUS_MAN, "Thesaurus table rebuilding thread threw exception", e);
            }
        }
    }
    ...
    private void createThesaurusRepository(Thesaurus gst) throws Exception {
        ...
        try {
            ...
            Log.error(Geonet.THESAURUS_MAN, "Create Thesaurus Repository error: " + e.getMessage(), e);
            throw e;
        }
    }
    ...
    public Thesaurus getThesaurusByConceptScheme(String uri) {
        ...
        for (Map.Entry<String, Thesaurus> entry : getThesauriMap().entrySet()) {
            try {
                ...
                Log.error(Geonet.THESAURUS_MAN, "Get Thesaurus by Concept Schema error: " + e.getMessage(), e);
            }
        }
