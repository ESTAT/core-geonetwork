...
public class SpatialIndexWriter implements FeatureListener
{
    ...
    public void delete(String id) throws IOException
    {
        ...
        try {
            ...
            try {
                ...
                Log.error(Geonet.INDEX_ENGINE,"SpatialIndexWriter delete error: " + e.getMessage(), e);
            }
            _writes++;
        } finally {
            _lock.unlock();
    ...
    public void commit() throws IOException
    {
        ...
        try {
            ...
            Log.error(Geonet.INDEX_ENGINE,"SpatialIndexWriter commit error: " + e.getMessage(), e);
        } finally {
            _lock.unlock();
        }
    ...
    private FeatureStore<SimpleFeatureType, SimpleFeature> createFeatureStore(DataStore datastore) throws Exception {
        Log.debug(Geonet.INDEX_ENGINE, "Configuring SpatialIndexWriter.");
