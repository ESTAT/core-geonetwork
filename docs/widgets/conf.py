...
manual = u' GeoNetwork widgets API Reference'
...
htmlhelp_basename = 'GeoNetworkJSAPI'
...
latex_documents = [
  ('index', 'GeoNetworkJSAPI.tex', u'GeoNetwork JS API Reference',
   u'GeoNetwork', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = '../eng/users/source/GeoNetwork_433.png'
