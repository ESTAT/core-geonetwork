(function() {
  ...
  goog.require('gn_search_estat_config');
  goog.require('gn_search_estat_directive');

  var module = angular.module('gn_search_estat',
      ['gn_search', 'gn_search_estat_config',
       'gn_search_estat_directive', 'gn_related_directive',
