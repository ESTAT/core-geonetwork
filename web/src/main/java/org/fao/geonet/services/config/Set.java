...
public class Set implements Service
{
	...
	private ConfigEntry entries[] =
	{
		...
		new ConfigEntry(ConfigEntry.Type.STRING, true,  "xlinkResolver/ignore",         "system/xlinkResolver/ignore"),
		...
		new ConfigEntry(ConfigEntry.Type.STRING, false, "statistics/snippet",            "system/statistics/snippet")
