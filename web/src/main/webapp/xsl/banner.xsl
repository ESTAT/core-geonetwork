...
<!-- 							<a id="browse-tab" class="selected" href="javascript:showBrowse();"> -->
		                    <a id="browse-tab" class="selected" href="{/root/gui/locService}/search">
			               ...
			               <span id="login-stuff">
							<a id="user-button">
								<xsl:choose>
									...
									<xsl:otherwise>
								  	<xsl:attribute name="href"><xsl:value-of select="$baseUrl" />/j_spring_security_logout</xsl:attribute>
