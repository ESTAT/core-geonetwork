...
<xsl:stylesheet version="2.0"
	...
	<xsl:variable name="rssUrl"
		select="concat($serviceUrl, '/rss.search?sortBy=changeDate')" />
		...
		<html class="no-js">
			...
			<head>
				...
				<!--[if lt IE 7]> <link rel="stylesheet"> <xsl:attribute name="href"><xsl:value-of 
					select="$baseUrl" />/apps/html5ui/css/ltie7.css"/></xsl:attribute> </link> 
					<![endif] -->
			...
			<body class="euShortContent">
				<div class="layout" id="cookie-warning" style="display: none;">
					<div id="cookie-container">
						...
						<p id="cookie-warning-message">This site uses cookies to offer you a better browsing
							experience.</p>
				...
				<div id="splashscreen" class="layout x-hidden">
				</div>
				<div class="layout" id="layout">
					<div class="lang-en" id="header">
						...
						<p id="banner-title-text" style="color:#0065A2">Geoportal of the European
							Commission</p>
						...
						<ul class="reset-list" id="services">
							...
							<li>
								<a href="{/root/gui/url}/docs/eng/users/index.html"
							...
							<li>
								<span id="login-stuff" style="display:none;">
									<a id="user-button">
										<xsl:choose>
											<xsl:when test="string(/root/gui/session/userId)=''">
												<xsl:attribute name="href"><xsl:value-of
													select="$baseUrl" />/login</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
									...
									<!-- The following login section is not used but is references in 
										LoginApp.js -->
									<!-- Do not remove before changing LoginApp.js -->
									<!-- <script>function false_(){ return false; }</script> -->
									<!-- <form id="login-form" style="display:none;" onsubmit="return 
										false_();"> -->
						...
						<!-- <a class="reset-list language-selector-title" href="javascript:toggle('lang-form');"><span 
							id="current-lang">English</span>&#160;<i class="fa fa-angle-double-down"></i> 
							<div id="lang-form" style="display:none;"> </div> </a> -->




						<!-- <a class="reset-list language-selector" href="javascript:toggle('lang-form');"><span 
							id="current-lang">English</span>&#160;<i class="fa fa-angle-double-down"></i> -->
					...
					<div id="page-container">
						<div id="container">
							<a class="off-screen" id="content" name="content"></a>
							...
							<ul class="reset-list" id="additional-tools">
								...
								<li>
									<a href="javascript:tools.fonts.decrease();" id="Decrease text">
										<img src="../../apps/html5ui/images/font-decrease.gif"
											alt="smaller font" />
									</a>
								</li>
								<li>
									<a href="javascript:tools.fonts.increase();" id="Increase text">
										<img border="0" src="../../apps/html5ui/images/font-increase.gif"
											alt="Larger font" />
									</a>
								</li>
								...
								<li>
									<div id="share-tool">
										<script type="text/javascript">if(typeof iBeginShare ==
											"object"){iBeginShare.attachLink('share-tool');}</script>
									</div>
								</li>
								<!-- <li><a id="rss-button" href="/geonetwork/srv/eng/rss.latest"><img 
									alt="smaller font" id="rss" src="/geonetwork/apps/html5ui/images/buttonRSS.gif"></img></a></li> -->
							</ul>
							...
							<div id="main">
								...
								<div id="share-capabilities" style="display:none">
									<a id="custom-tweet-button" href="javascript:void(0);"
										target="_blank">
									...
									<fieldset id="search-form-fieldset">
										<div id="search-form-top">
											...
											<input type="button"
												...
												onmouseover="Ext.get(this).addClass('hover');" onmouseout="Ext.get(this).removeClass('hover');"
											...
											<div class="form-dummy">
												<span>
													<xsl:value-of select="/root/gui/strings/dummySearch" />
												</span>
												<div id="ck1" />
												<div id="ck2" />
												<div id="ck3" />
											...
											<div id="show-advanced" onclick="showAdvancedSearch()">
												<span class="button">
													...
													&#160;
													<i class="fa fa-angle-double-down fa-2x show-advanced-icon"></i>
												</span>
											</div>
											<div id="hide-advanced" onclick="hideAdvancedSearch(true)"
												style="display: none;">
												<span class="button">
													<xsl:value-of select="/root/gui/strings/advancedOptions.hide" />
													&#160;
													<i class="fa fa-angle-double-up fa-2x hide-advanced-icon"></i>
												</span>
											</div>
										</div>
										<div id="advanced-search-options">
											<div id="advanced-search-options-content"></div>
											<div id="advanced-search-options-buttom-line"
												style="height: 10px; padding-left: 15px; padding-right: 15px; border-bottom:2px solid #69c" />
										</div>
									</fieldset>
								</div>
								...
								<div id="browser">
									<div id="welcome-text">
										...
										<xsl:if
											test="string(/root/gui/session/userId)!='' and string(/root/gui/session/profile)='Guest'">
										...
										<aside class="tag-aside">
											...
											<div id="tags">
												<header>
													<h1>
														<span>
															<xsl:value-of select="/root/gui/strings/tag_label" />
														</span>
													</h1>
												</header>
												...
												<section>
													<div id="featured-metadata">
														<header>
															<h1>
																<span>
																	<xsl:value-of select="/root/gui/strings/featuredDatasets" />
																</span>
															</h1>
														</header>
													</div>
													<div id="my-metadata" style="display:none">
														<header>
															<h1>
																<span>
																	<xsl:value-of select="/root/gui/strings/myDatasets" />
																</span>
															</h1>
														</header>
													</div>
													<div id="popular-metadata">
														<header>
															<h1>
																<span>
																	<xsl:value-of select="/root/gui/strings/popularDatasets" />
																</span>
															</h1>
														</header>
													</div>
													<div id="latest-metadata">
														<header>
															<h1>
																<span>
																	<xsl:value-of select="/root/gui/strings/latestDatasets" />
																</span>
															</h1>
														</header>
													</div>
								...
								<div id="search-container" class="main wrapper clearfix">
									...
									<aside id="main-aside" class="main-aside" style="display:none;">
										<header>
											<xsl:value-of select="/root/gui/strings/filter" />
										</header>
				...
				<!-- <a href="javascript:window.print();" id="printer-button"><i class="fa 
					fa-print"></i><xsl:value-of select="/root/gui/strings/print-button"/></a> -->
				<!-- <a id="rss-button" href="/geonetwork/srv/eng/rss.latest"><i class="fa 
					fa-rss-square"></i><xsl:value-of select="/root/gui/strings/rss-button"/></a> -->
				<!-- <span id="login-stuff"> -->
				<!-- <a id="user-button"> -->
				<!-- <xsl:choose> -->
				<!-- <xsl:when test="string(/root/gui/session/userId)=''"> -->
				...
				<!-- </form> -->
				<!-- </span> -->
				<!-- from here on, all elements are floated to the right so they are 
					in reverse order -->
				...
				<!-- <span id="current-lang"><xsl:value-of select="/root/gui/strings/*[name(.)=$lang]"/></span>&#160;<i 
				...
				<!-- <div id="page-container"> -->
				<!-- <div id="container"> -->
				<!-- <a class="off-screen" id="content" name="content"></a><p class="off-screen">Additional 
					tools</p> -->
				<!-- <ul class="reset-list" id="additional-tools"> -->
				<!-- <li><a href="javascript:window.print();" id="printer-button"><img 
					alt="Print version" src="/geonetwork/apps/html5ui/images/print.gif"></img></a></li> -->
				<!-- <li><a href="javascript:tools.fonts.decrease();" title="Decrease 
					text"><img alt="smaller font" id="small font" src="/geonetwork/apps/html5ui/images/font-decrease.gif"></img></a></li> -->
				<!-- <li><a href="javascript:tools.fonts.increase();" title="Increase 
					text"><img alt="smaller font" id="small font" src="/geonetwork/apps/html5ui/images/font-increase.gif"></img></a></li> -->
				<!-- <li> -->
				<!-- <div id="share-tool"><script type="text/javascript">if(typeof iBeginShare 
					== "object"){iBeginShare.attachLink('share-tool');}</script></div> -->
				<!-- </li> -->
				<!-- <li><a id="rss-button" href="/geonetwork/srv/eng/rss.latest"><img 
					alt="smaller font" id="rss" src="/geonetwork/apps/html5ui/images/buttonRSS.gif"></img></a></li> -->
				<!-- </ul> -->
				...
				<!-- <div id="show-advanced" onclick="showAdvancedSearch()"> -->
				<!-- <span class="button"><xsl:value-of select="/root/gui/strings/advancedOptions.show" 
					/>&#160;<i class="fa fa-angle-double-down fa-2x show-advanced-icon"></i></span> -->
				<!-- </div> -->
				<!-- <div id="hide-advanced" onclick="hideAdvancedSearch(true)" style="display: 
					none;"> -->
				<!-- <span class="button"><xsl:value-of select="/root/gui/strings/advancedOptions.hide" 
					/>&#160;<i class="fa fa-angle-double-up fa-2x hide-advanced-icon"></i></span> -->
				<!-- </div> -->
				<!-- <div id="advanced-search-options" > -->
				<!-- <div id="advanced-search-options-content"></div> -->
				<!-- </div> -->
				...
				<!-- </div> -->
				<!-- <div id="tags"> -->
				<!-- <header><h1><span><xsl:value-of select="/root/gui/strings/tag_label" 
					/></span></h1></header> -->
				<!-- <div id="cloud-tag"></div> -->
				<!-- </div> -->
				<!-- </aside> -->
				...
				<!-- <section> -->
				<!-- <div id="latest-metadata"> -->
				<!-- <header><h1><span><xsl:value-of select="/root/gui/strings/latestDatasets" 
					/></span></h1></header> -->
				<!-- </div> -->
				<!-- <div id="popular-metadata"> -->
				<!-- <header><h1><span><xsl:value-of select="/root/gui/strings/popularDatasets" 
					/></span></h1></header> -->
				<!-- </div> -->
				<!-- </section> -->
				<!-- </div> -->
				...
				<!-- <header><xsl:value-of select="/root/gui/strings/recentlyViewed" 
					/></header> -->
				...
				<div class="layout-footer" id="EC-footer">
					<ul class="footer-items">
						<li class="modification-date">
							<span>
								Last update:
								<xsl:value-of select="/root/gui/env/site/build_date" />
							</span>
						</li>
						<li>
							<a href="#">Top</a>
						...
						<li>
							<a id="browse-tab" class="selected" href="javascript:showBrowse();">Home</a>
						</li>
						<xsl:if test="string(/root/gui/session/userId)!=''">
							<li>
								<a id="catalog-tab" href="javascript:showSearch();">
				...
				<xsl:choose>
					...
					<xsl:otherwise>
						<script type="text/javascript"
							src="{concat($baseUrl, '/apps/html5ui/js/App-mini.js')}"></script>
						<script type="text/javascript"
							src="{concat($baseUrl, '/apps/html5ui/js/GlobalFunctions.js')}"></script>
					</xsl:otherwise>
				</xsl:choose>


				<xsl:value-of select="/root/gui/env/statistics/snippet"
